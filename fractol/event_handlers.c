...
int show_coordinates(int button, int px, int py, t_my_display *my_display)
{
	...
	{
		x = convert_pixel_to_coordinate(px, &(my_display->img_data), &(my_display->img_data.fractol), 'x');
		y = convert_pixel_to_coordinate(py, &(my_display->img_data), &(my_display->img_data.fractol), 'y');
...
int change_julia(int px, int py, t_my_display *my_display)
{
	...
	{
		my_display->img_data.fractol.c.real = convert_pixel_to_coordinate(px, &(my_display->img_data), &(my_display->img_data.fractol), 'x');
		my_display->img_data.fractol.c.imag = convert_pixel_to_coordinate(py, &(my_display->img_data), &(my_display->img_data.fractol), 'y');
		julia(&(my_display->img_data));
		mlx_put_image_to_window(my_display->mlx, my_display->win, my_display->img_data.img_ptr, 0, 0);
		return (0);
	}
...
void color_range_shift(t_my_display *my_display)
{
